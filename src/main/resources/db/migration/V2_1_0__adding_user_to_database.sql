...
insert into ticket (name, description, created_on, desired_resolution_date, assignee_id, owner_id, category, urgency,
                    approver_id)
values ('First ticket', 'Computer broke down', '2023-11-24 18:14:10', '2023-11-26', 1, 3,
        'HARDWARE_AND_SOFTWARE',
        'HIGH', 2);
insert into ticket (name, description, created_on, desired_resolution_date, assignee_id, owner_id, category, urgency,
                    approver_id)
values ('Second ticket', 'Mouse is not working', '2023-11-26 15:14:10', '2023-11-30', 1, 3,
        'HARDWARE_AND_SOFTWARE',
        'HIGH', 2);
insert into ticket (name, description, created_on, desired_resolution_date, assignee_id, owner_id, category, urgency,
                    approver_id)
values ('Third ticket', 'The Internet connection is low', '2023-11-29 19:14:10', '2023-11-30', 2, 3,
        'HARDWARE_AND_SOFTWARE',
        'HIGH', 2);